...
#' 
#' \code{CarsSold}: The number of car sold by the car dealer to be considered as output variable in DEA.
#'
#' \code{WorkOrders}: The number of works orders for the mechanical garage to be considered as output variable in DEA.
#' 
#' @details
